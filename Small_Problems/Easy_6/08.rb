...
# Enum#detect passes each number in the array to the block.
# Array#count counts the number of nums in arr.
# The block returns the first num for which there is a count greater than 1,
