...
# given a string
# #str
# split string at into sentances at . ! ?
# and store sentances in Array
# ##arr = str.split(/[.!?]/)

# determine the longest sentence in Array
# # initiate variable "longest_sentence"
# # iterate thru array comparing current sentence to longest_sentence length
# # storing sentence in longest_sentence if sentence is longer in length

# print the longest sentence and its number of words
# # print longest_sentence & length
